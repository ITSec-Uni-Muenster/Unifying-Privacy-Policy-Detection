...
pip install boilerpipe3==1.3 guess-language-spirit==0.5.3 langid==1.1.6 multi-rake pycld2==0.41 pycld3==0.20 pymupdf==1.18.6 readabilipy==0.2.0 polyglot==16.7.4 html-sanitizer==1.9.1 markdownify==0.10.3
which python
